...
class _$AuthStateImpl implements _AuthState {
  ...
  @override
  String toString() {
    return 'AuthState(isLoading: $isLoading, isGoogleLoading: $isGoogleLoading, errorMessage: $errorMessage, status: $status)';
  }
  ...
  int get hashCode => Object.hash(
      runtimeType, isLoading, isGoogleLoading, errorMessage, status);
